    ...
    <AnimatePresence mode="await">
      {showModal && (
        <motion.section
          ...
          initial="hidden"
          animate="visible"
          className="fixed w-full h-full top-0 left-0 bg-deep-blue opacity-5 z-10"
        >
          <motion.div
